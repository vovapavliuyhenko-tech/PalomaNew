/* ════════════════════════════════════════════════════════
   ...
   возвращает на thank-you.html?paid=1, где клиент выбирает мессенджер и
   отправляет менеджеру готовый текст заказа с пометкой об оплате
   (см. thank-you.js, ветка order.custom — берётся order.message).
