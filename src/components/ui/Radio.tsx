...
/** Квадратный переключатель в editorial-стиле (как в ТЗ этапа 3). */
      ...
      >
        <input
          ...
          className={cn(
            ...
            "checked:border-[var(--color-bordeaux)] checked:bg-[var(--color-bordeaux)] checked:shadow-[inset_0_0_0_2px_var(--color-cream)]",
